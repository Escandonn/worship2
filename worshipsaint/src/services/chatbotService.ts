...
class NgrokChatbotService implements ChatbotService {
  ...
  constructor(
    ...
    systemPrompt = import.meta.env.PUBLIC_CHATBOT_SYSTEM_PROMPT || 'Eres un asistente de WorshipSaint, una marca que mezcla deporte, diseño, tecnología y espiritualidad. Habla con tono premium, cercano y elegante. Presenta la marca, sus valores, su propósito y responde en español.'
  ) {
    this.apiKey = apiKey;
